  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        ...
        <a class="navbar-brand text-success logo h1 align-self-center" href="{{ url('/Admin') }}">
          Zay
        </a>
        <a class="sidebar-brand brand-logo-mini" href="{{url('/Admin')}}"><img src="{{@asset('/assets/images/logo-mini.svg')}}" alt="logo" /></a>
      </div>
      <ul class="nav">
