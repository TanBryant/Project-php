            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('/Admin/insertProduct') }}" method="POST">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="img" class="form-control" id="exampleInputEmail3" placeholder="Link img">
                    </div>
                    <div class="form-group">
                      <label >Price</label>
                    ...
                    <div class="form-group">
                      <label >Status</label>
                      <input type="text" name="status" class="form-control" id="exampleInputCity1" placeholder="Status">
                    </div>
                    <div class="form-group">
